...
* 
* @return double * matrix - одномерный массив размером k*k+2, 
* содержащий количество строк (элемент matrix[-2]), 
* столбцов (элемент matrix[-1]) и все элементы матрицы, 
* записанные построчно.
*
...
* @param unsigned int n - коичество столбцов
* @param unsigned int m - количество строк
* 
...
* 
*/
double elemIndex(unsigned int i, unsigned int j, unsigned int 
n,unsigned int m );
/**
* Display matrix
